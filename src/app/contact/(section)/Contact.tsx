    ...
    <section className="flex h-full w-full items-center justify-center bg-[#000000]">
      <div className="flex h-full w-full flex-col gap-[2.5rem] px-0 pl-0 md:px-2 items-center justify-center pb-12 md:pb-24">
            ...
            <div className="flex w-full flex-col gap-6 px-3 lg:w-3/5 lg:px-0">
              <div className="flex gap-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href="https://maps.app.goo.gl/B5Hphbdh2hhN3J6r9">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex flex-col gap-4 break-all">
                  <p>info@ephesus-brighton.co.uk</p>
                </div>
              </div>
            </div>
        ...
        <div className="w-full flex max-w-[1300px]">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2520.4812440172295!2d-0.15440388900012988!3d50.82224937154739!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48758512fe3a84e7%3A0xfabb253bebdf41ea!2s5%20Preston%20St%2C%20Brighton%20and%20Hove%2C%20Brighton%2C%20UK!5e0!3m2!1sen!2sin!4v1732709339745!5m2!1sen!2sin"
            style={{ border: 0 }}
            allowFullScreen
            loading="lazy"
