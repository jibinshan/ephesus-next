...
const Reviews = ({ }) => {
    ...
    return (
        <section className="relative flex h-full w-full justify-center bg-transparent">
            <div className="flex h-full w-full max-w-[1300px] flex-col items-center justify-center gap-4 py-12 md:py-44">
                <div className="flex h-full w-full flex-col items-center justify-center gap-2 lg:gap-4">
                    <h3 className="font-mono uppercase flex gap-2 items-center justify-center">
                        ...
                        <span
                            className="text-lg font-thin font-mono uppercase text-[#DCCF90] leading-[80%] tracking-[5px]">Reviews</span>
                        <div className="py-[1px] w-14 bg-[#DCCF90] h-0"></div>
                    </h3>
